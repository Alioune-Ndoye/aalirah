...
const services: Record<string, ServicePage> = {
  ...
  'commercial-cleaning': {
    ...
    icon: '🏢',
    hero_desc: "Your workspace is a direct reflection of your brand. Alira's commercial cleaning service covers offices, retail spaces, medical suites, restaurants, and commercial facilities throughout Central Connecticut — discreet, efficient, and thorough.",
    includes: [
  ...
  'airbnb-cleaning': {
    ...
    icon: '🛎',
    hero_desc: "Your Airbnb rating depends on cleanliness above everything else. Alira's short-term rental turnover service is built for speed and precision — rapid guest-to-guest turnaround, linen-ready, photo-ready, and review-worthy every single time.",
    includes: [
  ...
  'post-construction-cleaning': {
    ...
    icon: '🔨',
    hero_desc: "Construction and renovation leave behind fine dust, adhesive residue, paint overspray, and debris invisible to the untrained eye. Alira's specialist post-construction cleaning team uses professional equipment to reveal your new or renovated space exactly as it was designed.",
    includes: [
  ...
  'luxury-estate-cleaning': {
    ...
    icon: '✨',
    hero_desc: "High-value properties require a different level of care — precision-trained staff, premium products, total discretion, and a tailored programme built around your specific home, your schedule, and your standards. Alira's Luxury Estate Care is available by appointment throughout Central Connecticut.",
    includes: [
  ...
  'deep-cleaning': {
    ...
    icon: '🧹',
    hero_desc: "A deep clean goes far beyond routine maintenance — it's a top-to-bottom reset that tackles built-up grime, neglected corners, grout, inside appliances, and every surface that regular cleaning misses. Alira's deep cleaning service is the ideal first-time clean, spring clean, post-illness sanitization, or pre-listing preparation for any Connecticut home.",
    includes: [
