...
const paths: Record<IconName, React.ReactNode> = {
  ...
  heart: <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78L12 21.36l7.84-7.78a5.5 5.5 0 000-7.97z" />,
  camera: (
    <>
  ...
  swap: <path d="M8 3L4 7l4 4M16 3l4 4-4 4" />,
  calendar: (
    <>
...
export default function Icon({ name, size = 18, strokeWidth = 1.8, fill = false, className }: Props) {
  return (
    <svg
      width={size}
      height={size}
